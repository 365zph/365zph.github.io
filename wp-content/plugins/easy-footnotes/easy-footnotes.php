...
class easyFootnotes {
	...
	public function easy_footnote_shortcode($atts, $content = null) {
		...
		$footnoteContent = "<span id='easy-footnote-".$this->footnoteCount."' class='easy-footnote-margin-adjust'></span><span class='easy-footnote'><a href='".$footnoteLink."' title='$content'><sup>注$this->footnoteCount</sup></a></span>";
